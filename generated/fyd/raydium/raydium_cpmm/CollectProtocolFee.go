...
func (obj CollectProtocolFee) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *CollectProtocolFee) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *CollectProtocolFee) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 12 {
...
func (obj *CollectProtocolFee) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*CollectProtocolFee) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_CollectProtocolFee)
}

func (*CollectProtocolFee) NewInstance() programparser.Instruction {
...
func NewCollectProtocolFeeInstruction(
	...
	if err = enc__.WriteBytes(Instruction_CollectProtocolFee[:], false); err != nil {
...
// Builds a "BuildCollectProtocolFee" instruction.
// Collect the protocol fee accrued to the pool //  // # Arguments //  // * `ctx` - The context of accounts // * `amount_0_requested` - The maximum amount of token_0 to send, can be 0 to collect fees in only token_1 // * `amount_1_requested` - The maximum amount of token_1 to send, can be 0 to collect fees in only token_0 //
func BuildCollectProtocolFee(
	// Params:
	amount0RequestedParam uint64,
	amount1RequestedParam uint64,
	...
	instruction_, _ := NewCollectProtocolFeeInstruction(
