...
type OpenPositionWithToken22Nft struct {
	...
	// [9] = [writable] token_account_0
	TokenAccount0 solanago.PublicKey `bin:"-"`
	// [10] = [writable] token_account_1
	TokenAccount1 solanago.PublicKey `bin:"-"`
	// [11] = [writable] token_vault_0
	TokenVault0 solanago.PublicKey `bin:"-"`
	// [12] = [writable] token_vault_1
	TokenVault1 solanago.PublicKey `bin:"-"`
	// [13] = [] rent[SysvarRent111111111111111111111111111111111]
	Rent solanago.PublicKey `bin:"-"`
	// [14] = [] system_program
	SystemProgram solanago.PublicKey `bin:"-"`
	// [15] = [] token_program[TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA]
	TokenProgram solanago.PublicKey `bin:"-"`
	// [16] = [] associated_token_program[ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL]
	AssociatedTokenProgram solanago.PublicKey `bin:"-"`
	// [17] = [] token_program_2022[TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb]
...
func (obj OpenPositionWithToken22Nft) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *OpenPositionWithToken22Nft) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *OpenPositionWithToken22Nft) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 20 {
	...
	obj.ProtocolPosition = accounts[5]
	obj.TickArrayLower = accounts[6]
	obj.TickArrayUpper = accounts[7]
	obj.PersonalPosition = accounts[8]
	obj.TokenAccount0 = accounts[9]
	obj.TokenAccount1 = accounts[10]
	obj.TokenVault0 = accounts[11]
	obj.TokenVault1 = accounts[12]
	obj.Rent = accounts[13]
	obj.SystemProgram = accounts[14]
	obj.TokenProgram = accounts[15]
	obj.AssociatedTokenProgram = accounts[16]
	obj.TokenProgram2022 = accounts[17]
	obj.Vault0Mint = accounts[18]
	obj.Vault1Mint = accounts[19]
	obj.PublicKeySlice = accounts
	return nil
}
func (obj *OpenPositionWithToken22Nft) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*OpenPositionWithToken22Nft) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_OpenPositionWithToken22Nft)
}

func (*OpenPositionWithToken22Nft) NewInstance() programparser.Instruction {
	return new(OpenPositionWithToken22Nft)
}
...
func NewOpenPositionWithToken22NftInstruction(
	...
	if err = enc__.WriteBytes(Instruction_OpenPositionWithToken22Nft[:], false); err != nil {
	...
	// Add the accounts to the instruction.
	{
		...
		metas_[5] = solanago.NewAccountMeta(protocolPosition, true, false)
		// [6] = [writable] tick_array_lower
		metas_[6] = solanago.NewAccountMeta(tickArrayLower, true, false)
		// [7] = [writable] tick_array_upper
		metas_[7] = solanago.NewAccountMeta(tickArrayUpper, true, false)
		// [8] = [writable] personal_position
		// personal position state
		metas_[8] = solanago.NewAccountMeta(personalPosition, true, false)
		// [9] = [writable] token_account_0
		// The token_0 account deposit token to the pool
		metas_[9] = solanago.NewAccountMeta(tokenAccount0, true, false)
		// [10] = [writable] token_account_1
		// The token_1 account deposit token to the pool
		metas_[10] = solanago.NewAccountMeta(tokenAccount1, true, false)
		// [11] = [writable] token_vault_0
		// The address that holds pool tokens for token_0
		metas_[11] = solanago.NewAccountMeta(tokenVault0, true, false)
		// [12] = [writable] token_vault_1
		// The address that holds pool tokens for token_1
		metas_[12] = solanago.NewAccountMeta(tokenVault1, true, false)
		// [13] = [] rent[SysvarRent111111111111111111111111111111111]
		...
		metas_[16] = solanago.NewAccountMeta(AssociatedTokenProgram, false, false)
		// [17] = [] token_program_2022[TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb]
		// Program to create NFT mint/token account and transfer for token22 account
		metas_[17] = solanago.NewAccountMeta(TokenProgram2022, false, false)
		// [18] = [] vault_0_mint
		// The mint of token vault 0
		metas_[18] = solanago.NewAccountMeta(vault0Mint, false, false)
		// [19] = [] vault_1_mint
		// The mint of token vault 1
		metas_[19] = solanago.NewAccountMeta(vault1Mint, false, false)
...
// Builds a "BuildOpenPositionWithToken22Nft" instruction.
// Creates a new position wrapped in a Token2022 NFT without relying on metadata_program and metadata_account, reduce the cost for user to create a personal position. //  // # Arguments //  // * `ctx` - The context of accounts // * `tick_lower_index` - The low boundary of market // * `tick_upper_index` - The upper boundary of market // * `tick_array_lower_start_index` - The start index of tick array which include tick low // * `tick_array_upper_start_index` - The start index of tick array which include tick upper // * `liquidity` - The liquidity to be added, if zero, and the base_flag is specified, calculate liquidity base amount_0_max or amount_1_max according base_flag, otherwise open position with zero liquidity // * `amount_0_max` - The max amount of token_0 to spend, which serves as a slippage check // * `amount_1_max` - The max amount of token_1 to spend, which serves as a slippage check // * `with_metadata` - The flag indicating whether to create NFT mint metadata // * `base_flag` - if the liquidity specified as zero, true: calculate liquidity base amount_0_max otherwise base amount_1_max //
func BuildOpenPositionWithToken22Nft(
	// Params:
	tickLowerIndexParam int32,
	tickUpperIndexParam int32,
	tickArrayLowerStartIndexParam int32,
	...
	instruction_, _ := NewOpenPositionWithToken22NftInstruction(
		tickLowerIndexParam,
		tickUpperIndexParam,
