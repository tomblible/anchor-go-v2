...
func (obj InitializeV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *InitializeV2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *InitializeV2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 18 {
...
func (obj *InitializeV2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*InitializeV2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_InitializeV2)
}

func (*InitializeV2) NewInstance() programparser.Instruction {
...
func NewInitializeV2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_InitializeV2[:], false); err != nil {
...
// Builds a "BuildInitializeV2" instruction.
// Initializes a new trading pool // # Arguments //  // * `ctx` - The context of accounts containing pool and token information //
func BuildInitializeV2(
	// Params:
	baseMintParamParam MintParams,
	curveParamParam CurveParams,
	vestingParamParam VestingParams,
	...
	instruction_, _ := NewInitializeV2Instruction(
		baseMintParamParam,
		curveParamParam,
		vestingParamParam,
		ammFeeOnParam,
