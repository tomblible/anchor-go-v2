...
func (obj BuyExactOut) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *BuyExactOut) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *BuyExactOut) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*BuyExactOut) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_BuyExactOut)
}

func (*BuyExactOut) NewInstance() programparser.Instruction {
...
func NewBuyExactOutInstruction(
	...
	if err = enc__.WriteBytes(Instruction_BuyExactOut[:], false); err != nil {
...
// Builds a "BuildBuyExactOut" instruction.
// Use quote tokens to purchase the given amount of base tokens. // # Arguments //  // * `ctx` - The context of accounts // * `amount_out` - Amount of base token to receive // * `maximum_amount_in` - Maximum amount of quote token to purchase (slippage protection) // * `share_fee_rate` - Fee rate for the share
func BuildBuyExactOut(
	// Params:
	amountOutParam uint64,
	maximumAmountInParam uint64,
	shareFeeRateParam uint64,
