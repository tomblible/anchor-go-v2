...
func (obj *CreateMetadataAccountV2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 7 {
...
func (obj *CreateMetadataAccountV2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*CreateMetadataAccountV2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_CreateMetadataAccountV2)
}

func (*CreateMetadataAccountV2) NewInstance() programparser.Instruction {
	return new(CreateMetadataAccountV2)
}

func (obj *CreateMetadataAccountV2) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewCreateMetadataAccountV2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_CreateMetadataAccountV2[:], false); err != nil {
...
// Builds a "BuildCreateMetadataAccountV2" instruction.
func BuildCreateMetadataAccountV2(
	metadata solanago.PublicKey,
	mint solanago.PublicKey,
	mintAuthority solanago.PublicKey,
	payer solanago.PublicKey,
	...
	instruction_, _ := NewCreateMetadataAccountV2Instruction(
		metadata,
		mint,
		mintAuthority,
		payer,
