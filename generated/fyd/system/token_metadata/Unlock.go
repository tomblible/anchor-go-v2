...
func (obj Unlock) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	{
		if err = EncodeUnlockArgs(encoder, obj.UnlockArgs); err != nil {
			return fmt.Errorf("error while marshalingunlockArgsParam:%w", err)
		}
	}
	return nil
}
...
func (obj *Unlock) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	{
		var err error
		obj.UnlockArgs, err = DecodeUnlockArgs(decoder)
		if err != nil {
			return err
		}
	}
...
func (obj *Unlock) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 13 {
...
func (obj *Unlock) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*Unlock) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_Unlock)
}

func (*Unlock) NewInstance() programparser.Instruction {
	return new(Unlock)
}

func (obj *Unlock) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewUnlockInstruction(
	...
	if err = enc__.WriteBytes(Instruction_Unlock[:], false); err != nil {
...

	{
		// Serialize `unlockArgsParam`:
		{
			if err = EncodeUnlockArgs(enc__, unlockArgsParam); err != nil {
				return nil, fmt.Errorf("error while marshalingunlockArgsParam:%w", err)
			}
		}
	}
...
// Builds a "BuildUnlock" instruction.
func BuildUnlock(
	// Params:
	unlockArgsParam UnlockArgs,
	...
	instruction_, _ := NewUnlockInstruction(
		unlockArgsParam,
		authority,
		tokenOwner,
		token,
