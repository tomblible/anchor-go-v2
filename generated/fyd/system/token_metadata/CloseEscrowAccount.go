...
func (obj *CloseEscrowAccount) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 8 {
...
func (obj *CloseEscrowAccount) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*CloseEscrowAccount) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_CloseEscrowAccount)
}

func (*CloseEscrowAccount) NewInstance() programparser.Instruction {
	return new(CloseEscrowAccount)
}

func (obj *CloseEscrowAccount) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewCloseEscrowAccountInstruction(
	...
	if err = enc__.WriteBytes(Instruction_CloseEscrowAccount[:], false); err != nil {
...
// Builds a "BuildCloseEscrowAccount" instruction.
func BuildCloseEscrowAccount(
	escrow solanago.PublicKey,
	metadata solanago.PublicKey,
	mint solanago.PublicKey,
	tokenAccount solanago.PublicKey,
	...
	instruction_, _ := NewCloseEscrowAccountInstruction(
		escrow,
		metadata,
		mint,
		tokenAccount,
