...
func (obj *SignMetadata) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 2 {
...
func (obj *SignMetadata) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*SignMetadata) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_SignMetadata)
}

func (*SignMetadata) NewInstance() programparser.Instruction {
	return new(SignMetadata)
}

func (obj *SignMetadata) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewSignMetadataInstruction(
	...
	if err = enc__.WriteBytes(Instruction_SignMetadata[:], false); err != nil {
...
// Builds a "BuildSignMetadata" instruction.
func BuildSignMetadata(
	metadata solanago.PublicKey,
	creator solanago.PublicKey,
	remaining__ ...*solanago.AccountMeta,
) *solanago.GenericInstruction {
	instruction_, _ := NewSignMetadataInstruction(
		metadata,
		creator,
		remaining__...,
	)
