...
// Builds a "transfer_tokens_checked" instruction.
type TransferTokensChecked struct {
	// Params:
	Amount   uint64
	Decimals uint8
	// Accounts:
...
func (obj TransferTokensChecked) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *TransferTokensChecked) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Amount`:
...
func (obj *TransferTokensChecked) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 4 {
...
func (obj *TransferTokensChecked) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*TransferTokensChecked) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_TransferTokensChecked)
}

func (*TransferTokensChecked) NewInstance() programparser.Instruction {
	return new(TransferTokensChecked)
}

func (obj *TransferTokensChecked) GetRemainingAccounts() solanago.PublicKeySlice {
...
// Builds a "transfer_tokens_checked" instruction.
func NewTransferTokensCheckedInstruction(
	// Params:
	amountParam uint64,
	decimalsParam uint8,
	...
	if err = enc__.WriteBytes(Instruction_TransferTokensChecked[:], false); err != nil {
...
// Builds a "BuildTransferTokensChecked" instruction.
func BuildTransferTokensChecked(
	// Params:
	amountParam uint64,
	decimalsParam uint8,
	...
	instruction_, _ := NewTransferTokensCheckedInstruction(
		amountParam,
		decimalsParam,
		source,
		mint,
