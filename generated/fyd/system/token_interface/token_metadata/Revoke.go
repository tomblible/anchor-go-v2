...
func (obj Revoke) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.RevokeArgs); err != nil {
		return fmt.Errorf("error while marshaling revokeArgsParam:%w", err)
	}
	return nil
}
...
func (obj *Revoke) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	if err = decoder.Decode(&obj.RevokeArgs); err != nil {
		return fmt.Errorf("error while unmarshaling RevokeArgs:%w", err)
	}
	return nil
}
...
func NewRevokeInstruction(
	...
	{
		// Serialize `revokeArgsParam`:
		if err = enc__.Encode(revokeArgsParam); err != nil {
			return nil, fmt.Errorf("error while marshaling revokeArgsParam:%w", err)
		}
	}
