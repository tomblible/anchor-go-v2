...
func (obj *VerifyCollection) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 7 {
...
func (obj *VerifyCollection) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*VerifyCollection) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_VerifyCollection)
}

func (*VerifyCollection) NewInstance() programparser.Instruction {
	return new(VerifyCollection)
}

func (obj *VerifyCollection) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewVerifyCollectionInstruction(
	...
	if err = enc__.WriteBytes(Instruction_VerifyCollection[:], false); err != nil {
	...
	// Add the accounts to the instruction.
	{
		...
		metas_[4] = solanago.NewAccountMeta(collection, false, false)
		// [5] = [] collection_master_edition_account
...
// Builds a "BuildVerifyCollection" instruction.
func BuildVerifyCollection(
	metadata solanago.PublicKey,
	collectionAuthority solanago.PublicKey,
	payer solanago.PublicKey,
	collectionMint solanago.PublicKey,
	...
	instruction_, _ := NewVerifyCollectionInstruction(
		metadata,
		collectionAuthority,
		payer,
		collectionMint,
