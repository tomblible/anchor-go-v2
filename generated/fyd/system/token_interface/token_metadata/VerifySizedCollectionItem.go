...
func (obj *VerifySizedCollectionItem) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 7 {
...
func (obj *VerifySizedCollectionItem) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*VerifySizedCollectionItem) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_VerifySizedCollectionItem)
}

func (*VerifySizedCollectionItem) NewInstance() programparser.Instruction {
	return new(VerifySizedCollectionItem)
}

func (obj *VerifySizedCollectionItem) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewVerifySizedCollectionItemInstruction(
	...
	if err = enc__.WriteBytes(Instruction_VerifySizedCollectionItem[:], false); err != nil {
...
// Builds a "BuildVerifySizedCollectionItem" instruction.
func BuildVerifySizedCollectionItem(
	metadata solanago.PublicKey,
	collectionAuthority solanago.PublicKey,
	payer solanago.PublicKey,
	collectionMint solanago.PublicKey,
	...
	instruction_, _ := NewVerifySizedCollectionItemInstruction(
		metadata,
		collectionAuthority,
		payer,
		collectionMint,
