...
func (obj CreateMasterEditionV3) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.CreateMasterEditionArgs); err != nil {
		return fmt.Errorf("error while marshaling createMasterEditionArgsParam:%w", err)
	}
	return nil
}
...
func (obj *CreateMasterEditionV3) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 9 {
...
func (obj *CreateMasterEditionV3) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*CreateMasterEditionV3) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_CreateMasterEditionV3)
}

func (*CreateMasterEditionV3) NewInstance() programparser.Instruction {
	return new(CreateMasterEditionV3)
}

func (obj *CreateMasterEditionV3) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewCreateMasterEditionV3Instruction(
	...
	if err = enc__.WriteBytes(Instruction_CreateMasterEditionV3[:], false); err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}

	{
		// Serialize `createMasterEditionArgsParam`:
		if err = enc__.Encode(createMasterEditionArgsParam); err != nil {
			return nil, fmt.Errorf("error while marshaling createMasterEditionArgsParam:%w", err)
		}
	}
...
// Builds a "BuildCreateMasterEditionV3" instruction.
func BuildCreateMasterEditionV3(
	// Params:
	createMasterEditionArgsParam CreateMasterEditionArgs,
	...
	instruction_, _ := NewCreateMasterEditionV3Instruction(
		createMasterEditionArgsParam,
		edition,
		mint,
		updateAuthority,
		mintAuthority,
