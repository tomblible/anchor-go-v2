...
func (obj *CreateMetadataAccount) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 7 {
...
func (obj *CreateMetadataAccount) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*CreateMetadataAccount) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_CreateMetadataAccount)
}

func (*CreateMetadataAccount) NewInstance() programparser.Instruction {
	return new(CreateMetadataAccount)
}

func (obj *CreateMetadataAccount) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewCreateMetadataAccountInstruction(
	...
	if err = enc__.WriteBytes(Instruction_CreateMetadataAccount[:], false); err != nil {
...
// Builds a "BuildCreateMetadataAccount" instruction.
func BuildCreateMetadataAccount(
	metadata solanago.PublicKey,
	mint solanago.PublicKey,
	mintAuthority solanago.PublicKey,
	payer solanago.PublicKey,
	...
	instruction_, _ := NewCreateMetadataAccountInstruction(
		metadata,
		mint,
		mintAuthority,
		payer,
