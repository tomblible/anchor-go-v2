...
func (obj WithdrawStrategy) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *WithdrawStrategy) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Amount`:
...
func (obj *WithdrawStrategy) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 10 {
...
func (obj *WithdrawStrategy) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*WithdrawStrategy) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_WithdrawStrategy)
}

func (*WithdrawStrategy) NewInstance() programparser.Instruction {
	return new(WithdrawStrategy)
}

func (obj *WithdrawStrategy) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewWithdrawStrategyInstruction(
	...
	if err = enc__.WriteBytes(Instruction_WithdrawStrategy[:], false); err != nil {
...
// Builds a "BuildWithdrawStrategy" instruction.
// withdraw liquidity from a strategy
func BuildWithdrawStrategy(
	// Params:
	amountParam uint64,
	...
	instruction_, _ := NewWithdrawStrategyInstruction(
		amountParam,
		vault,
		strategy,
		tokenVault,
