...
func (obj Deposit) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.TokenAmount); err != nil {
		return fmt.Errorf("error while marshaling tokenAmountParam:%w", err)
	}
	// Serialize `minimumLpTokenAmountParam`:
	if err = encoder.Encode(obj.MinimumLpTokenAmount); err != nil {
		return fmt.Errorf("error while marshaling minimumLpTokenAmountParam:%w", err)
	}
	return nil
}
...
func (obj *Deposit) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	if err = decoder.Decode(&obj.MinimumLpTokenAmount); err != nil {
		return fmt.Errorf("error while unmarshaling MinimumLpTokenAmount:%w", err)
	}
	return nil
}
...
func NewDepositInstruction(
	...
	{
		// Serialize `tokenAmountParam`:
		if err = enc__.Encode(tokenAmountParam); err != nil {
			return nil, fmt.Errorf("error while marshaling tokenAmountParam:%w", err)
		}
		// Serialize `minimumLpTokenAmountParam`:
		if err = enc__.Encode(minimumLpTokenAmountParam); err != nil {
			return nil, fmt.Errorf("error while marshaling minimumLpTokenAmountParam:%w", err)
		}
	}
