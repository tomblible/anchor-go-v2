...
type InitializePermissionlessConstantProductPoolWithConfig2 struct {
	// Params:
	TokenAAmount    uint64
	TokenBAmount    uint64
...
func (obj InitializePermissionlessConstantProductPoolWithConfig2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	// Serialize `activationPointParam` (optional):
	{
		if obj.ActivationPoint == nil {
			if err = encoder.WriteOption(false); err != nil {
				return fmt.Errorf("error while marshaling activationPointParam optionality: %w", err)
			}
		} else {
...
func (obj *InitializePermissionlessConstantProductPoolWithConfig2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *InitializePermissionlessConstantProductPoolWithConfig2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 26 {
...
func (obj *InitializePermissionlessConstantProductPoolWithConfig2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*InitializePermissionlessConstantProductPoolWithConfig2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_InitializePermissionlessConstantProductPoolWithConfig2)
}

func (*InitializePermissionlessConstantProductPoolWithConfig2) NewInstance() programparser.Instruction {
	return new(InitializePermissionlessConstantProductPoolWithConfig2)
}

func (inst *InitializePermissionlessConstantProductPoolWithConfig2) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewInitializePermissionlessConstantProductPoolWithConfig2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_InitializePermissionlessConstantProductPoolWithConfig2[:], false); err != nil {
		...
		// Serialize `activationPointParam` (optional):
		{
			if activationPointParam == nil {
				if err = enc__.WriteOption(false); err != nil {
					return nil, fmt.Errorf("error while marshaling activationPointParam optionality: %w", err)
				}
			} else {
...
// Builds a "BuildInitializePermissionlessConstantProductPoolWithConfig2" instruction.
// Initialize permissionless pool with config 2
func BuildInitializePermissionlessConstantProductPoolWithConfig2(
	// Params:
	tokenAAmountParam uint64,
	tokenBAmountParam uint64,
	activationPointParam *uint64,
	...
	instruction_, _ := NewInitializePermissionlessConstantProductPoolWithConfig2Instruction(
		tokenAAmountParam,
		tokenBAmountParam,
