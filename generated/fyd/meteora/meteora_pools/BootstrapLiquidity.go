...
func (obj *BootstrapLiquidity) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *BootstrapLiquidity) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*BootstrapLiquidity) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_BootstrapLiquidity)
}

func (*BootstrapLiquidity) NewInstance() programparser.Instruction {
...
func NewBootstrapLiquidityInstruction(
	...
	if err = enc__.WriteBytes(Instruction_BootstrapLiquidity[:], false); err != nil {
...
// Builds a "BuildBootstrapLiquidity" instruction.
// Bootstrap the pool when liquidity is depleted.
func BuildBootstrapLiquidity(
	// Params:
	tokenAAmountParam uint64,
	tokenBAmountParam uint64,
	...
	instruction_, _ := NewBootstrapLiquidityInstruction(
		tokenAAmountParam,
		tokenBAmountParam,
		pool,
		lpMint,
