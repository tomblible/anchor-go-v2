...
func (obj AddBalanceLiquidity) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.MaximumTokenAAmount); err != nil {
		return fmt.Errorf("error while marshaling maximumTokenAAmountParam:%w", err)
	}
	// Serialize `maximumTokenBAmountParam`:
	if err = encoder.Encode(obj.MaximumTokenBAmount); err != nil {
		return fmt.Errorf("error while marshaling maximumTokenBAmountParam:%w", err)
	}
	return nil
}

func (obj *AddBalanceLiquidity) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	if err = decoder.Decode(&obj.MaximumTokenAAmount); err != nil {
		return fmt.Errorf("error while unmarshaling MaximumTokenAAmount:%w", err)
	}
	// Deserialize `MaximumTokenBAmount`:
	if err = decoder.Decode(&obj.MaximumTokenBAmount); err != nil {
		return fmt.Errorf("error while unmarshaling MaximumTokenBAmount:%w", err)
	}
	return nil
}

func (obj *AddBalanceLiquidity) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *AddBalanceLiquidity) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*AddBalanceLiquidity) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_AddBalanceLiquidity)
}

func (*AddBalanceLiquidity) NewInstance() programparser.Instruction {
	return new(AddBalanceLiquidity)
}

func (inst *AddBalanceLiquidity) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewAddBalanceLiquidityInstruction(
	...
	if err = enc__.WriteBytes(Instruction_AddBalanceLiquidity[:], false); err != nil {
...

	{
		...
		// Serialize `maximumTokenAAmountParam`:
		if err = enc__.Encode(maximumTokenAAmountParam); err != nil {
			return nil, fmt.Errorf("error while marshaling maximumTokenAAmountParam:%w", err)
		}
		// Serialize `maximumTokenBAmountParam`:
		if err = enc__.Encode(maximumTokenBAmountParam); err != nil {
			return nil, fmt.Errorf("error while marshaling maximumTokenBAmountParam:%w", err)
		}
	}
...
// Builds a "BuildAddBalanceLiquidity" instruction.
// Deposit tokens to the pool in a balanced ratio.
func BuildAddBalanceLiquidity(
	// Params:
	poolTokenAmountParam uint64,
	maximumTokenAAmountParam uint64,
	maximumTokenBAmountParam uint64,
	...
	instruction_, _ := NewAddBalanceLiquidityInstruction(
		poolTokenAmountParam,
		maximumTokenAAmountParam,
		maximumTokenBAmountParam,
		pool,
		lpMint,
		userPoolLp,
		aVaultLp,
