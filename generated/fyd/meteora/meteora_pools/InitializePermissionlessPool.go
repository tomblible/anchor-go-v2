...
func (obj InitializePermissionlessPool) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *InitializePermissionlessPool) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *InitializePermissionlessPool) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 26 {
...
func (obj *InitializePermissionlessPool) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*InitializePermissionlessPool) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_InitializePermissionlessPool)
}

func (*InitializePermissionlessPool) NewInstance() programparser.Instruction {
	return new(InitializePermissionlessPool)
}

func (inst *InitializePermissionlessPool) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewInitializePermissionlessPoolInstruction(
	...
	if err = enc__.WriteBytes(Instruction_InitializePermissionlessPool[:], false); err != nil {
...
// Builds a "BuildInitializePermissionlessPool" instruction.
// Initialize a new permissionless pool.
func BuildInitializePermissionlessPool(
	// Params:
	curveTypeParam CurveType,
	tokenAAmountParam uint64,
	tokenBAmountParam uint64,
	...
	instruction_, _ := NewInitializePermissionlessPoolInstruction(
		curveTypeParam,
		tokenAAmountParam,
		tokenBAmountParam,
		pool,
