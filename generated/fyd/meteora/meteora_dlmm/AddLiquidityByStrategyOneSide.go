...
func (obj AddLiquidityByStrategyOneSide) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *AddLiquidityByStrategyOneSide) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *AddLiquidityByStrategyOneSide) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 12 {
...
func (obj *AddLiquidityByStrategyOneSide) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*AddLiquidityByStrategyOneSide) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_AddLiquidityByStrategyOneSide)
}

func (*AddLiquidityByStrategyOneSide) NewInstance() programparser.Instruction {
...
func NewAddLiquidityByStrategyOneSideInstruction(
	...
	if err = enc__.WriteBytes(Instruction_AddLiquidityByStrategyOneSide[:], false); err != nil {
...
// Builds a "BuildAddLiquidityByStrategyOneSide" instruction.
func BuildAddLiquidityByStrategyOneSide(
	// Params:
	liquidityParameterParam LiquidityParameterByStrategyOneSide,
	...
	instruction_, _ := NewAddLiquidityByStrategyOneSideInstruction(
