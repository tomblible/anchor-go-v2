...
func (obj AddLiquidityByWeight) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *AddLiquidityByWeight) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *AddLiquidityByWeight) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *AddLiquidityByWeight) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*AddLiquidityByWeight) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_AddLiquidityByWeight)
}

func (*AddLiquidityByWeight) NewInstance() programparser.Instruction {
...
func NewAddLiquidityByWeightInstruction(
	...
	if err = enc__.WriteBytes(Instruction_AddLiquidityByWeight[:], false); err != nil {
...
// Builds a "BuildAddLiquidityByWeight" instruction.
func BuildAddLiquidityByWeight(
	// Params:
	liquidityParameterParam LiquidityParameterByWeight,
	...
	instruction_, _ := NewAddLiquidityByWeightInstruction(
