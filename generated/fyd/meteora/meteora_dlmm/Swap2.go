...
func (obj Swap2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.MinAmountOut); err != nil {
		return fmt.Errorf("error while marshaling minAmountOutParam:%w", err)
	}
...
func (obj *Swap2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	if err = decoder.Decode(&obj.MinAmountOut); err != nil {
		return fmt.Errorf("error while unmarshaling MinAmountOut:%w", err)
	}
...
func (obj *Swap2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *Swap2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*Swap2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_Swap2)
}

func (*Swap2) NewInstance() programparser.Instruction {
	return new(Swap2)
}
...
func NewSwap2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_Swap2[:], false); err != nil {
...

	{
		...
		// Serialize `minAmountOutParam`:
		if err = enc__.Encode(minAmountOutParam); err != nil {
			return nil, fmt.Errorf("error while marshaling minAmountOutParam:%w", err)
		}
		// Serialize `remainingAccountsInfoParam`:
...
// Builds a "BuildSwap2" instruction.
func BuildSwap2(
	// Params:
	amountInParam uint64,
	minAmountOutParam uint64,
	...
	instruction_, _ := NewSwap2Instruction(
		amountInParam,
		minAmountOutParam,
