...
func (obj *ClaimFee) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	...
	obj.UserTokenY = accounts[8]
	obj.TokenXMint = accounts[9]
	obj.TokenYMint = accounts[10]
...
func NewClaimFeeInstruction(
	...
	// Add the accounts to the instruction.
	{
		...
		// [7] = [writable] user_token_x
		metas_[7] = solanago.NewAccountMeta(userTokenX, true, false)
		// [8] = [writable] user_token_y
		metas_[8] = solanago.NewAccountMeta(userTokenY, true, false)
		// [9] = [] token_x_mint
		metas_[9] = solanago.NewAccountMeta(tokenXMint, false, false)
		// [10] = [] token_y_mint
		metas_[10] = solanago.NewAccountMeta(tokenYMint, false, false)
		// [11] = [] token_program[TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA]
