...
func (obj RemoveAllLiquidity) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	return nil
}

func (obj *RemoveAllLiquidity) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	return nil
}

func (obj *RemoveAllLiquidity) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *RemoveAllLiquidity) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*RemoveAllLiquidity) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_RemoveAllLiquidity)
}

func (*RemoveAllLiquidity) NewInstance() programparser.Instruction {
	return new(RemoveAllLiquidity)
}

func (inst *RemoveAllLiquidity) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewRemoveAllLiquidityInstruction(
	...
	if err = enc__.WriteBytes(Instruction_RemoveAllLiquidity[:], false); err != nil {
...
// Builds a "BuildRemoveAllLiquidity" instruction.
func BuildRemoveAllLiquidity(
	position solanago.PublicKey,
	lbPair solanago.PublicKey,
	binArrayBitmapExtension solanago.PublicKey,
	userTokenX solanago.PublicKey,
	...
	instruction_, _ := NewRemoveAllLiquidityInstruction(
		position,
		lbPair,
