...
func (obj AddLiquidityByStrategy2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *AddLiquidityByStrategy2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *AddLiquidityByStrategy2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 14 {
...
func (obj *AddLiquidityByStrategy2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*AddLiquidityByStrategy2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_AddLiquidityByStrategy2)
}

func (*AddLiquidityByStrategy2) NewInstance() programparser.Instruction {
	return new(AddLiquidityByStrategy2)
}

func (inst *AddLiquidityByStrategy2) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewAddLiquidityByStrategy2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_AddLiquidityByStrategy2[:], false); err != nil {
...
// Builds a "BuildAddLiquidityByStrategy2" instruction.
func BuildAddLiquidityByStrategy2(
	// Params:
	liquidityParameterParam LiquidityParameterByStrategy,
	remainingAccountsInfoParam RemainingAccountsInfo,
	...
	instruction_, _ := NewAddLiquidityByStrategy2Instruction(
