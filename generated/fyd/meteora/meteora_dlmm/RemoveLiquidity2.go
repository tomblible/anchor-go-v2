...
func (obj RemoveLiquidity2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	// Serialize `binLiquidityRemovalParam`:
	if err = encoder.Encode(obj.BinLiquidityRemoval); err != nil {
		return fmt.Errorf("error while marshaling binLiquidityRemovalParam:%w", err)
	}
...
func (obj *RemoveLiquidity2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `BinLiquidityRemoval`:
	if err = decoder.Decode(&obj.BinLiquidityRemoval); err != nil {
		return fmt.Errorf("error while unmarshaling BinLiquidityRemoval:%w", err)
	}
...
func (obj *RemoveLiquidity2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 15 {
...
func (obj *RemoveLiquidity2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*RemoveLiquidity2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_RemoveLiquidity2)
}

func (*RemoveLiquidity2) NewInstance() programparser.Instruction {
	return new(RemoveLiquidity2)
}

func (inst *RemoveLiquidity2) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewRemoveLiquidity2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_RemoveLiquidity2[:], false); err != nil {
		return nil, fmt.Errorf("failed to write instruction discriminator: %w", err)
	}

	{
		// Serialize `binLiquidityRemovalParam`:
		if err = enc__.Encode(binLiquidityRemovalParam); err != nil {
			return nil, fmt.Errorf("error while marshaling binLiquidityRemovalParam:%w", err)
		}
		// Serialize `remainingAccountsInfoParam`:
...
// Builds a "BuildRemoveLiquidity2" instruction.
func BuildRemoveLiquidity2(
	// Params:
	binLiquidityRemovalParam []BinLiquidityReduction,
	remainingAccountsInfoParam RemainingAccountsInfo,
	...
	instruction_, _ := NewRemoveLiquidity2Instruction(
		binLiquidityRemovalParam,
