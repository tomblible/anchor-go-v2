...
func (obj RemoveLiquidityByRange) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *RemoveLiquidityByRange) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *RemoveLiquidityByRange) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *RemoveLiquidityByRange) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*RemoveLiquidityByRange) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_RemoveLiquidityByRange)
}

func (*RemoveLiquidityByRange) NewInstance() programparser.Instruction {
...
func NewRemoveLiquidityByRangeInstruction(
	...
	if err = enc__.WriteBytes(Instruction_RemoveLiquidityByRange[:], false); err != nil {
...
// Builds a "BuildRemoveLiquidityByRange" instruction.
func BuildRemoveLiquidityByRange(
	// Params:
	fromBinIdParam int32,
	toBinIdParam int32,
	bpsToRemoveParam uint16,
	...
	instruction_, _ := NewRemoveLiquidityByRangeInstruction(
		fromBinIdParam,
		toBinIdParam,
		bpsToRemoveParam,
		position,
