...
func (obj AddLiquidityOneSide) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *AddLiquidityOneSide) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *AddLiquidityOneSide) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 12 {
...
func (obj *AddLiquidityOneSide) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*AddLiquidityOneSide) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_AddLiquidityOneSide)
}

func (*AddLiquidityOneSide) NewInstance() programparser.Instruction {
	return new(AddLiquidityOneSide)
}

func (inst *AddLiquidityOneSide) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewAddLiquidityOneSideInstruction(
	...
	if err = enc__.WriteBytes(Instruction_AddLiquidityOneSide[:], false); err != nil {
...
// Builds a "BuildAddLiquidityOneSide" instruction.
func BuildAddLiquidityOneSide(
	// Params:
	liquidityParameterParam LiquidityOneSideParameter,
	...
	instruction_, _ := NewAddLiquidityOneSideInstruction(
