...
func (obj SwapWithPriceImpact2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *SwapWithPriceImpact2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *SwapWithPriceImpact2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
...
func (obj *SwapWithPriceImpact2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*SwapWithPriceImpact2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_SwapWithPriceImpact2)
}

func (*SwapWithPriceImpact2) NewInstance() programparser.Instruction {
...
func NewSwapWithPriceImpact2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_SwapWithPriceImpact2[:], false); err != nil {
...
// Builds a "BuildSwapWithPriceImpact2" instruction.
func BuildSwapWithPriceImpact2(
	// Params:
	amountInParam uint64,
	activeIdParam *int32,
	maxPriceImpactBpsParam uint16,
	...
	instruction_, _ := NewSwapWithPriceImpact2Instruction(
		amountInParam,
		activeIdParam,
