...
type InitializeVirtualPoolWithSplToken struct {
	...
	// [9] = [] metadata_program[metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s]
	...
	// [12] = [] token_program[TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA]
...
func (obj InitializeVirtualPoolWithSplToken) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *InitializeVirtualPoolWithSplToken) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Params`:
...
func (obj *InitializeVirtualPoolWithSplToken) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 16 {
	...
	obj.MintMetadata = accounts[8]
	obj.MetadataProgram = accounts[9]
...
func (obj *InitializeVirtualPoolWithSplToken) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*InitializeVirtualPoolWithSplToken) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_InitializeVirtualPoolWithSplToken)
}

func (*InitializeVirtualPoolWithSplToken) NewInstance() programparser.Instruction {
...
func NewInitializeVirtualPoolWithSplTokenInstruction(
	...
	if err = enc__.WriteBytes(Instruction_InitializeVirtualPoolWithSplToken[:], false); err != nil {
	...
	// Add the accounts to the instruction.
	{
		...
		// [8] = [writable] mint_metadata
		metas_[8] = solanago.NewAccountMeta(mintMetadata, true, false)
		// [9] = [] metadata_program[metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s]
		metas_[9] = solanago.NewAccountMeta(MetadataProgram, false, false)
		// [10] = [writable,signer] payer
...
// Builds a "BuildInitializeVirtualPoolWithSplToken" instruction.
// POOL CREATOR FUNCTIONS ////
func BuildInitializeVirtualPoolWithSplToken(
	// Params:
	paramsParam InitializePoolParameters,
	...
	instruction_, _ := NewInitializeVirtualPoolWithSplTokenInstruction(
		paramsParam,
		config,
		creator,
		baseMint,
