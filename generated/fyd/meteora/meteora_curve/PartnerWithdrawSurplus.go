...
type PartnerWithdrawSurplus struct {
	// Params:
	// Accounts:
...
func (obj PartnerWithdrawSurplus) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	return nil
}

func (obj *PartnerWithdrawSurplus) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	return nil
}

func (obj *PartnerWithdrawSurplus) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 10 {
...
func (obj *PartnerWithdrawSurplus) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*PartnerWithdrawSurplus) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_PartnerWithdrawSurplus)
}

func (*PartnerWithdrawSurplus) NewInstance() programparser.Instruction {
...
func NewPartnerWithdrawSurplusInstruction(
	...
	if err = enc__.WriteBytes(Instruction_PartnerWithdrawSurplus[:], false); err != nil {
	...
	// Add the accounts to the instruction.
	{
		...
		// [6] = [,signer] fee_claimer
		metas_[6] = solanago.NewAccountMeta(feeClaimer, false, true)
		// [7] = [] token_quote_program
		// Token b program
...
// Builds a "BuildPartnerWithdrawSurplus" instruction.
func BuildPartnerWithdrawSurplus(
	config solanago.PublicKey,
	virtualPool solanago.PublicKey,
	tokenQuoteAccount solanago.PublicKey,
	quoteVault solanago.PublicKey,
	...
	instruction_, _ := NewPartnerWithdrawSurplusInstruction(
		config,
		virtualPool,
		tokenQuoteAccount,
		quoteVault,
