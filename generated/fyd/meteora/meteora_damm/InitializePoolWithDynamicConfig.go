...
type InitializePoolWithDynamicConfig struct {
	...
	PoolCreatorAuthority solanago.PublicKey `bin:"-"`
	// [5] = [] config
	Config solanago.PublicKey `bin:"-"`
	// [6] = [] pool_authority[HLnpSz9h2S4hiLQ43rnSD9XkcUThA7B8hQMKmDaiTLcC]
	...
	// [17] = [] token_2022_program[TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb]
...
func (obj InitializePoolWithDynamicConfig) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *InitializePoolWithDynamicConfig) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `Params`:
...
func (obj *InitializePoolWithDynamicConfig) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 21 {
	...
	obj.PoolCreatorAuthority = accounts[4]
	obj.Config = accounts[5]
	obj.PoolAuthority = accounts[6]
	obj.Pool = accounts[7]
	obj.Position = accounts[8]
	obj.TokenAMint = accounts[9]
	obj.TokenBMint = accounts[10]
	obj.TokenAVault = accounts[11]
	obj.TokenBVault = accounts[12]
	obj.PayerTokenA = accounts[13]
	obj.PayerTokenB = accounts[14]
	obj.TokenAProgram = accounts[15]
	obj.TokenBProgram = accounts[16]
	obj.Token2022Program = accounts[17]
	obj.SystemProgram = accounts[18]
	obj.EventAuthority = accounts[19]
	obj.Program = accounts[20]
	obj.PublicKeySlice = accounts
	return nil
}
func (obj *InitializePoolWithDynamicConfig) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*InitializePoolWithDynamicConfig) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_InitializePoolWithDynamicConfig)
}

func (*InitializePoolWithDynamicConfig) NewInstance() programparser.Instruction {
...
func NewInitializePoolWithDynamicConfigInstruction(
	...
	if err = enc__.WriteBytes(Instruction_InitializePoolWithDynamicConfig[:], false); err != nil {
	...
	// Add the accounts to the instruction.
	{
		...
		// [4] = [,signer] pool_creator_authority
		metas_[4] = solanago.NewAccountMeta(poolCreatorAuthority, false, true)
		// [5] = [] config
		// Which config the pool belongs to.
		metas_[5] = solanago.NewAccountMeta(config, false, false)
		// [6] = [] pool_authority[HLnpSz9h2S4hiLQ43rnSD9XkcUThA7B8hQMKmDaiTLcC]
		metas_[6] = solanago.NewAccountMeta(PoolAuthority, false, false)
		// [7] = [writable] pool
		// Initialize an account to store the pool state
		metas_[7] = solanago.NewAccountMeta(pool, true, false)
		// [8] = [writable] position
		metas_[8] = solanago.NewAccountMeta(position, true, false)
		// [9] = [] token_a_mint
		// Token a mint
		metas_[9] = solanago.NewAccountMeta(tokenAMint, false, false)
		// [10] = [] token_b_mint
		// Token b mint
		metas_[10] = solanago.NewAccountMeta(tokenBMint, false, false)
		// [11] = [writable] token_a_vault
		// Token a vault for the pool
		metas_[11] = solanago.NewAccountMeta(tokenAVault, true, false)
		// [12] = [writable] token_b_vault
		// Token b vault for the pool
		metas_[12] = solanago.NewAccountMeta(tokenBVault, true, false)
		// [13] = [writable] payer_token_a
		...
		metas_[15] = solanago.NewAccountMeta(tokenAProgram, false, false)
		// [16] = [] token_b_program
		// Program to create mint account and mint tokens
		metas_[16] = solanago.NewAccountMeta(tokenBProgram, false, false)
		// [17] = [] token_2022_program[TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb]
		// Program to create NFT mint/token account and transfer for token22 account
		metas_[17] = solanago.NewAccountMeta(Token2022Program, false, false)
		// [18] = [] system_program
		metas_[18] = solanago.NewAccountMeta(SystemProgram, false, false)
		// [19] = [] event_authority
		metas_[19] = solanago.NewAccountMeta(eventAuthority, false, false)
		// [20] = [] program
		metas_[20] = solanago.NewAccountMeta(program, false, false)
...
// Builds a "BuildInitializePoolWithDynamicConfig" instruction.
func BuildInitializePoolWithDynamicConfig(
	// Params:
	paramsParam InitializeCustomizablePoolParameters,
	...
	instruction_, _ := NewInitializePoolWithDynamicConfigInstruction(
		paramsParam,
		creator,
		positionNftMint,
		positionNftAccount,
