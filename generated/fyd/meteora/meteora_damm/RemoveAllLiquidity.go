...
func (obj RemoveAllLiquidity) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.TokenAAmountThreshold); err != nil {
		return fmt.Errorf("error while marshaling tokenAAmountThresholdParam:%w", err)
	}
	// Serialize `tokenBAmountThresholdParam`:
	if err = encoder.Encode(obj.TokenBAmountThreshold); err != nil {
		return fmt.Errorf("error while marshaling tokenBAmountThresholdParam:%w", err)
	}
	return nil
}
...
func NewRemoveAllLiquidityInstruction(
	...
	{
		// Serialize `tokenAAmountThresholdParam`:
		if err = enc__.Encode(tokenAAmountThresholdParam); err != nil {
			return nil, fmt.Errorf("error while marshaling tokenAAmountThresholdParam:%w", err)
		}
		// Serialize `tokenBAmountThresholdParam`:
		if err = enc__.Encode(tokenBAmountThresholdParam); err != nil {
			return nil, fmt.Errorf("error while marshaling tokenBAmountThresholdParam:%w", err)
		}
	}
...
func BuildRemoveAllLiquidity(
	...
	instruction_, _ := NewRemoveAllLiquidityInstruction(
		tokenAAmountThresholdParam,
		tokenBAmountThresholdParam,
		pool,
		position,
		tokenAAccount,
		tokenBAccount,
