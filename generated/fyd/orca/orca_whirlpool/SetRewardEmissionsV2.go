...
func (obj SetRewardEmissionsV2) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *SetRewardEmissionsV2) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
...
func (obj *SetRewardEmissionsV2) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 3 {
...
func (obj *SetRewardEmissionsV2) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*SetRewardEmissionsV2) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_SetRewardEmissionsV2)
}

func (*SetRewardEmissionsV2) NewInstance() programparser.Instruction {
	return new(SetRewardEmissionsV2)
}

func (obj *SetRewardEmissionsV2) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewSetRewardEmissionsV2Instruction(
	...
	if err = enc__.WriteBytes(Instruction_SetRewardEmissionsV2[:], false); err != nil {
...
// Builds a "BuildSetRewardEmissionsV2" instruction.
// Set the reward emissions for a reward in a Whirlpool. //  // ### Authority // - "reward_authority" - assigned authority by the reward_super_authority for the specified // reward-index in this Whirlpool //  // ### Parameters // - `reward_index` - The reward index (0 <= index <= NUM_REWARDS) that we'd like to modify. // - `emissions_per_second_x64` - The amount of rewards emitted in this pool. //  // #### Special Errors // - `RewardVaultAmountInsufficient` - The amount of rewards in the reward vault cannot emit // more than a day of desired emissions. // - `InvalidTimestamp` - Provided timestamp is not in order with the previous timestamp. // - `InvalidRewardIndex` - If the provided reward index doesn't match the lowest uninitialized // index in this pool, or exceeds NUM_REWARDS, or // all reward slots for this pool has been initialized.
func BuildSetRewardEmissionsV2(
	// Params:
	rewardIndexParam uint8,
	emissionsPerSecondX64Param binary.Uint128,
	...
	instruction_, _ := NewSetRewardEmissionsV2Instruction(
		rewardIndexParam,
