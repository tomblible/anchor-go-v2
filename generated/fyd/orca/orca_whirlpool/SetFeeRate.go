...
func (obj SetFeeRate) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
...
func (obj *SetFeeRate) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	// Deserialize `FeeRate`:
...
func (obj *SetFeeRate) SetAccounts(accounts solanago.PublicKeySlice) (err error) {
	if len(accounts) < 3 {
...
func (obj *SetFeeRate) PublicKeys() solanago.PublicKeySlice {
	return obj.PublicKeySlice
}

func (*SetFeeRate) TypeID() binary.TypeID {
	return binary.TypeIDFromBytes(Instruction_SetFeeRate)
}

func (*SetFeeRate) NewInstance() programparser.Instruction {
	return new(SetFeeRate)
}

func (obj *SetFeeRate) GetRemainingAccounts() solanago.PublicKeySlice {
...
func NewSetFeeRateInstruction(
	...
	if err = enc__.WriteBytes(Instruction_SetFeeRate[:], false); err != nil {
...
// Builds a "BuildSetFeeRate" instruction.
// Sets the fee rate for a Whirlpool. // Fee rate is represented as hundredths of a basis point. // Only the current fee authority has permission to invoke this instruction. //  // ### Authority // - "fee_authority" - Set authority that can modify pool fees in the WhirlpoolConfig //  // ### Parameters // - `fee_rate` - The rate that the pool will use to calculate fees going onwards. //  // #### Special Errors // - `FeeRateMaxExceeded` - If the provided fee_rate exceeds MAX_FEE_RATE.
func BuildSetFeeRate(
	// Params:
	feeRateParam uint16,
	...
	instruction_, _ := NewSetFeeRateInstruction(
		feeRateParam,
		whirlpoolsConfig,
		whirlpool,
		feeAuthority,
