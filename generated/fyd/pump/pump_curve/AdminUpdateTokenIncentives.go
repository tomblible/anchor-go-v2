...
func (obj AdminUpdateTokenIncentives) MarshalWithEncoder(encoder *binary.Encoder) (err error) {
	...
	if err = encoder.Encode(obj.PumpTokenSupplyPerDay); err != nil {
		return fmt.Errorf("error while marshaling pumpTokenSupplyPerDayParam:%w", err)
	}
	return nil
}
...
func (obj *AdminUpdateTokenIncentives) UnmarshalWithDecoder(decoder *binary.Decoder) (err error) {
	...
	if err = decoder.Decode(&obj.PumpTokenSupplyPerDay); err != nil {
		return fmt.Errorf("error while unmarshaling PumpTokenSupplyPerDay:%w", err)
	}
	return nil
}
...
func NewAdminUpdateTokenIncentivesInstruction(
...

	{
		...
		// Serialize `pumpTokenSupplyPerDayParam`:
		if err = enc__.Encode(pumpTokenSupplyPerDayParam); err != nil {
			return nil, fmt.Errorf("error while marshaling pumpTokenSupplyPerDayParam:%w", err)
		}
	}
